...
In recent years,
the domain of \ac{cps} has undergone significant evolution to facilitate the realization of various application domains,
...
where offloading the computation to the cloud is the most common approach.
%
However,
...
but also improve the system's resiliency.
%
As a result,
...
%
The Edge-Cloud continuum brings new variables as the heterogeneity of devices and applications reaches unprecedented levels.
%
Moreover,
...
%
This dynamic nature of the system along with high levels of heterogeneity call for dynamic,
...
%
This suitability stems from their capacity to be worn,
removed, loaned out,
and can have different roles and uses.
%
For this reason,
