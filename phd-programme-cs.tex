...
\meta{
The results expected in this project can be applied to a wide range of systems,
but the main focus will be on improving the design and implementation of \ac{cas}.
%
}
