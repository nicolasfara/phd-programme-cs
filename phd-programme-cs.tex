...
% The scope of this project can be summarized as \textbf{Software engineering} where new models,
% design techniques,
% algorithms and methodologies will be proposed to simpl
% \textbf{Distributed intelligence}
% \textbf{Energy and cost efficiency}
% \textbf{Cyber-physical systems}
