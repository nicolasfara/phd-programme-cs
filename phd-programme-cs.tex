...
are one of the main objectives of the COMMON-WEARS project.

Based on the objective stated above,
this project tries to contribute in the following three main directions:

\begin{itemize}
	\item Leverage the \emph{pulverisation} for the deployment of \ac{cas} for wearable computing systems.
		In particular,
		...
		Moreover, \textbf{\ac{ai} techniques} will be investigated to support the dynamic reconfiguration of the system.
...
The following sections provide more details about the three main directions of this project,
in particular,
...
where the unpredictable nature of the environment made it difficult to predict the behavior of the system.
%
...
the data are produced at the edge of the network and then manipulated and processed on inner layers of the network, like the cloud.
%
...
Cloud computing has emerged as a new paradigm for the provisioning of computing resources.
%
The cloud continuum represents a hyped topic in the last few years,
and it is expected to be the future for the deployment of \ac{iot} and \ac{cps} systems, and more.
...
%
Moreover,
the integration of the pulverization framework with \ac{iac} tools like Terraform~\footnote{\url{https://www.terraform.io/}} and Ansible~\footnote{\url{https://www.ansible.com/}},
will be investigated to effectively manage the infrastructure provisioning.
...
Due to the highly distributed nature of data produces by \ac{iot} and \ac{cps} systems,
the use of appropriate techniques to manage the distributed stream of data is crucial.
%
For this reason,
the project will investigate the main techniques used in frameworks like \emph{Apache Kafka}~\footnote{\url{https://kafka.apache.org/}},
\emph{Apache Pulsar}~\footnote{\url{https://pulsar.apache.org/}} and \emph{Apache Flink}~\footnote{\url{https://flink.apache.org/}},
to understand how each of them try to solve the problem of managing the distributed stream of data.
%
% Moreover,
% the integration of the pulverisation approach with these technologies will be investigated to enable the possibility to perform data analysis on the data produced by the system.
