...
%
\meta{A relevant example in which the Edge-Cloud Continuum and wearable devices can be used in conjunction is
...
%
% The system should be able to adapt to the number of participants,
% the device's energy consumption,
% the network topology,
% and the latency for proximity marketing.
In this scenario,
...
% techniques and tools for the design and deployment of software systems,
% in particular wearable computing systems in the Edge-Cloud continuum,
...
% %
% \meta{This project emphasizes solving the above issues in the context of \ac{cas},
% where wearable devices cover a predominant role,
% by providing a design framework that can be used to design complex software systems,
...
%
\meta{Because of the impact these devices will have in our lives,
